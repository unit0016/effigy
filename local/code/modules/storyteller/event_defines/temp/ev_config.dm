/*
 * EffigyEdit TODO: Storyteller
 * Break these events down into their appropriate tracks
 * and adjust the weights/occurances to account for
 * the lack of Dynamic in the new system.
 */
