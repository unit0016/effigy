...
/datum/controller/subsystem/autotransfer/fire()
	...
	if(max_votes == NO_VOTE_CAP || max_votes > current_votes)
		log_game("Autotransfer: Vote initiated. RT:[REALTIMEOFDAY] RSUTC:[SSticker.round_utc_start_time] ST:[start_time] TT:[target_time] VI:[vote_interval] CV:[current_votes] MV:[max_votes] WT:[world.time] RST:[SSticker.round_start_time]")
...
/datum/controller/subsystem/autotransfer/proc/new_shift(round_start_real_time)
	...
	log_game("Autotransfer: RT:[REALTIMEOFDAY] RSUTC:[SSticker.round_utc_start_time] ST:[start_time] TT:[target_time] VI:[vote_interval] CV:[current_votes] MV:[max_votes] WT:[world.time] RST:[SSticker.round_start_time]")
