...
/datum/tgs_chat_command/tgscheck/Run(datum/tgs_chat_user/sender, params)
	...
	return new /datum/tgs_message_content("[GLOB.round_hex ? "Round [GLOB.round_hex] " : ""]on [SSmapping.current_map.map_name]; Connected: [GLOB.clients.len] - Active: [active_players] - Observing: [observing_players]; Shift [SSticker.HasRoundStarted() ? (SSticker.IsRoundInProgress() ? "active" : "ending") : "pending in lobby"] -- [server ? server : "[world.internet_address]:[world.port]"]")
