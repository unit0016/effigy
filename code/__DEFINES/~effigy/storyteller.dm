...
#define EVENT_TRACK_CREW "Crew"
#define EVENT_TRACK_GHOST "Ghost"

#define ALL_EVENTS "All"
#define UNCATEGORIZED_EVENTS "Uncategorized"

#define STORYTELLER_WAIT_TIME 16 SECONDS
...
#define MAJOR_MIN_POP 0
#define CREWSET_MIN_POP 0
#define GHOSTSET_MIN_POP 0

/// Defines for how much pop do we need to stop applying a pop scaling penalty to event frequency.
...
#define EVENT_TRACKS list(EVENT_TRACK_MUNDANE, EVENT_TRACK_MODERATE, EVENT_TRACK_MAJOR, EVENT_TRACK_CREW, EVENT_TRACK_GHOST)
#define EVENT_PANEL_TRACKS list(EVENT_TRACK_MUNDANE, EVENT_TRACK_MODERATE, EVENT_TRACK_MAJOR, EVENT_TRACK_CREW, EVENT_TRACK_GHOST, UNCATEGORIZED_EVENTS, ALL_EVENTS)
