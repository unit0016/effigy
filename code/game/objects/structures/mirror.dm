...
/obj/structure/mirror/proc/change_race(mob/living/carbon/human/race_changer)
	...
	if(HAS_TRAIT(race_changer, TRAIT_USES_SKINTONES))
		...
		var/new_mutantcolor = tgui_color_picker(race_changer, "Choose your skin color:", "Race change", race_changer.dna.features["mcolor"]) // EffigyEdit Change - TGUI Color Picker
		if(new_mutantcolor)
