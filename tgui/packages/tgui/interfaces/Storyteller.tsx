...
export const Storyteller = (props) => {
  return (
    <Window width={1200} height={680} title="Event Management">
      <Window.Content height="100%">
        <Stack fill vertical>
          <Stack.Item grow>
            <StorytellerRoundData />
            <Stack.Divider />
            <StorytellerTrackData />
          </Stack.Item>

          <Stack.Item grow>
            <Stack fill vertical>
              <Stack.Item>
                <StorytellerScheduledData />
              </Stack.Item>
              <Stack.Item grow>
                <StorytellerEventPanel />
              </Stack.Item>
            </Stack>
          </Stack.Item>
        </Stack>
...
export const StorytellerRoundData = (props) => {
    ...
    <Section
      ...
      buttons={
        <>
          ...
          <Button onClick={() => act('set_storyteller')}>Set Game Mode</Button>
        </>
      }
    >
      <LabeledList>
        <LabeledList.Item label="Event Tracks Status">
          <Button
...
export const StorytellerTrackData = (props) => {
  const { act, data } = useBackend<Storyteller_Data>();
...
export const StorytellerScheduledData = (props) => {
  const { act, data } = useBackend<Storyteller_Data>();
...
export const StorytellerEventPanel = (props) => {
  const { act, data } = useBackend<Storyteller_Data>();
  const { events } = data;
...
export const StorytellerEventPanelCategory = (
...
export const StorytellerEvent = (props: Event_Props) => {
